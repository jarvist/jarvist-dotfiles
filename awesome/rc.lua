...
-- JMF: Battery
-- adjusted to use modern: /sys/class/power_supply/BAT0/capacity
...
-- JMF: These all from: http://jasonmaur.com/awesome-wm-widgets-configuration/
